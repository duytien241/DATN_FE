...
export const AUTHENTICATION_LOGIN_ADMIN_SUCCESS = 'AUTHENTICATION_LOGIN_ADMIN_SUCCESS';
export const AUTHENTICATION_LOGIN_ADMIN_FAILED = 'AUTHENTICATION_LOGIN_ADMIN_FAILED';
